...
@Component({
  selector: 'app-paginator-factura-activas',
  templateUrl: './paginator-factura-activas.component.html',
  styles: []
})
export class PaginatorFacturaActivasComponent implements OnInit, OnChanges {
