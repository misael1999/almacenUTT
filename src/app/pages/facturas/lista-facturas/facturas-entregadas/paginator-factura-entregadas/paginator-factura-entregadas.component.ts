...
@Component({
  selector: 'app-paginator-factura-entregadas',
  templateUrl: './paginator-factura-entregadas.component.html',
  styles: []
})
export class PaginatorFacturaEntregadasComponent implements OnInit, OnChanges {
